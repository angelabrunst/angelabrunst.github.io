...
if (currentDay == eventDay) {
    document.getElementById("eventBanner").innerHTML = "Free Hot Cocoa in Soda Springs Community Park - Saturday morning @ 9:00am!"
}
...
//weather summary API
const apiCurrentURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.6544&lon=-111.6047&units=imperial&appid=242f1fb78f229667592c2503b963e887";
fetch(apiCurrentURL)
...
const apiForecastURL = "https://api.openweathermap.org/data/2.5/forecast?lat=42.6544&lon=-111.6047&units=imperial&appid=242f1fb78f229667592c2503b963e887";
